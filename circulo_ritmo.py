...
def pattern5 (): #정 위쪽 숨기기 (34.4초)
    screen.delay(0)
    b2.ht()
    b2.setpos(0,0)
    threading.Timer(3, pattern6).start()

def pattern6 (): #정 왼쪽 숨기기 (37.4초)
    screen.delay(0)
    b4.ht()
    b4.setpos(0, 0)
    threading.Timer(3, pattern7).start()

def pattern7 (): #정 아래쪽 숨기기 (39.9초)
    screen.delay(0)
    b3.ht()
    b3.setpos(0, 0)
    threading.Timer(2.7, pattern8).start()

def pattern8 (): #정 오른쪽 숨기기 (42.6초)
    screen.delay(0)
    b1.ht()
    b1.setpos(0,0)
...
def pattern11 (): # 정 오른쪽(3) (51.2 초)
    ...
    b1.setpos(300,0)
    b1.setheading(0)
    threading.Timer(1.5, pattern12).start()
...
def pattern12 (): #정 오른쪽 + 정 위쪽 (54.2 초)
    ...
    b2.setheading(270)
    b2.st()
    threading.Timer(2.7, pattern13).start()
...
def pattern13 (): #정 오른쪽 + 정 위쪽 + 정 왼쪽 (57.2초)
    ...
    b4.setheading(180)
    b4.st()
    threading.Timer(1.4 , pattern14).start()
...
def pattern14 (): #정 오른쪽 + 정 위쪽 + 정 왼쪽 + 정 아래쪽 (60.2초)
    ...
    b3.setheading(90)
    b3.st()
    threading.Timer(19, pattern15).start()
...
def pattern15 (): #상하좌우 숨기기 (77.2초)
    ...
    b3.setpos(0,0)
    b4.setpos(0,0)
    threading.Timer(3, pattern16).start()
